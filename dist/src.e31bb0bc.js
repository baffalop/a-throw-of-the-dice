...
var $author$project$Main$theme = {
	accent: $rtfeldman$elm_css$Css$hex('9e3354'),
	dark: $rtfeldman$elm_css$Css$hex('13151f'),
	initialLayerHue: 130,
	light: function (hue) {
		return A3($rtfeldman$elm_css$Css$hsl, hue, 0.3, 0.6);
	},
	lighter: function (hue) {
		return A3($rtfeldman$elm_css$Css$hsl, hue, 0.7, 0.75);
	}
};
...
var $author$project$Main$withNoCmd = A2($elm_community$basics_extra$Basics$Extra$flip, $elm$core$Tuple$pair, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$init = function (_v0) {
	var devicePixelRatio = _v0.devicePixelRatio;
	var screenDimensions = _v0.screenDimensions;
	var sourcePlane = $ianmackenzie$elm_geometry$SketchPlane3d$xy;
	var _v1 = screenDimensions;
	var screenWidth = _v1.a;
	var screenHeight = _v1.b;
	var centrePoint = A2($ianmackenzie$elm_geometry$Point2d$centimeters, screenWidth * (13.2 / 1000), screenHeight * (10 / 800));
	return $author$project$Main$withNoCmd(
		{
			azimuth: $ianmackenzie$elm_units$Angle$degrees(90),
			centrePoint: centrePoint,
			devicePixelRatio: devicePixelRatio,
			drawnRect: $elm$core$Maybe$Nothing,
			elevation: $ianmackenzie$elm_units$Angle$degrees(0),
			focus: A2($ianmackenzie$elm_geometry$Point3d$on, sourcePlane, centrePoint),
			layers: $STTR13$ziplist$ZipList$singleton(
				{hue: $author$project$Main$theme.initialLayerHue, plane: sourcePlane, rects: _List_Nil}),
...
var $author$project$Main$ArrowKeyPressed = function (a) {
	return {$: 'ArrowKeyPressed', a: a};
};
var $author$project$Main$CtrlZ = {$: 'CtrlZ'};
...
var $author$project$Main$arrowKeyDecoder = function (msg) {
	return A2(
			...
			switch (keycode) {
				case 'ArrowRight':
					return $elm$json$Json$Decode$succeed(
						msg($author$project$Main$Right));
				case 'ArrowLeft':
					return $elm$json$Json$Decode$succeed(
						msg($author$project$Main$Left));
				default:
					return $elm$json$Json$Decode$fail('nah');
			}
		},
...
var $author$project$Main$ctrlZDecoder = function (msg) {
	return $Gizra$elm_keyboard_event$Keyboard$Event$considerKeyboardEvent(
		function (_v0) {
			var ctrlKey = _v0.ctrlKey;
			var metaKey = _v0.metaKey;
			var key = _v0.key;
			return ((metaKey || ctrlKey) && _Utils_eq(
				key,
				$elm$core$Maybe$Just('z'))) ? $elm$core$Maybe$Just(msg) : $elm$core$Maybe$Nothing;
		});
};
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$oneOf(
					_List_fromArray(
						[
							$author$project$Main$ctrlZDecoder($author$project$Main$CtrlZ),
							$author$project$Main$arrowKeyDecoder($author$project$Main$ArrowKeyPressed)
						]))),
				...
				if (transition.$ === 'Nothing') {
					...
					return $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Main$AnimationTick);
				}
			}()
			]));
};
...
var $STTR13$ziplist$ZipList$Negatif = {$: 'Negatif'};
var $STTR13$ziplist$ZipList$Positif = {$: 'Positif'};
var $STTR13$ziplist$ZipList$Zero = {$: 'Zero'};
var $STTR13$ziplist$ZipList$sign = function (val) {
	return (!val) ? $STTR13$ziplist$ZipList$Zero : ((val > 0) ? $STTR13$ziplist$ZipList$Positif : $STTR13$ziplist$ZipList$Negatif);
};
...
var $author$project$Main$isFacingRightOf = function (viewpoint) {
	return A2(
		$elm$core$Basics$composeR,
		$ianmackenzie$elm_geometry$SketchPlane3d$normalDirection,
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				$elm$core$Maybe$map(
					A2(
						$elm$core$Basics$composeR,
						$ianmackenzie$elm_geometry$Direction2d$xComponent,
						A2($elm_community$basics_extra$Basics$Extra$flip, $elm$core$Basics$lt, 0))),
				$elm$core$Maybe$withDefault(false))));
};
var $author$project$Main$layerHueSpacing = 40;
...
var $ianmackenzie$elm_units$Constants$cssPixel = $ianmackenzie$elm_units$Constants$inch / 96;
var $ianmackenzie$elm_units$Length$cssPixels = function (numCssPixels) {
	return $ianmackenzie$elm_units$Length$meters($ianmackenzie$elm_units$Constants$cssPixel * numCssPixels);
};
...
var $author$project$Main$makeScreenRectangle = A2(
	$elm$core$Basics$composeR,
	A2(
		$elm$core$Tuple$mapBoth,
		A2($elm$core$Basics$composeR, $elm$core$Basics$toFloat, $ianmackenzie$elm_units$Length$cssPixels),
		A2($elm$core$Basics$composeR, $elm$core$Basics$toFloat, $ianmackenzie$elm_units$Length$cssPixels)),
	A2(
		$elm$core$Basics$composeR,
		$elm_community$basics_extra$Basics$Extra$uncurry($ianmackenzie$elm_geometry$Point2d$xy),
		$ianmackenzie$elm_geometry$Rectangle2d$from($ianmackenzie$elm_geometry$Point2d$origin)));
...
var $author$project$Main$viewDistance = $ianmackenzie$elm_units$Length$centimeters(25);
...
var $author$project$Main$makeViewpoint = function (_v0) {
	var focus = _v0.focus;
	var azimuth = _v0.azimuth;
	var elevation = _v0.elevation;
	return $ianmackenzie$elm_3d_camera$Viewpoint3d$orbit(
		{azimuth: azimuth, distance: $author$project$Main$viewDistance, elevation: elevation, focalPoint: focus, groundPlane: $ianmackenzie$elm_geometry$SketchPlane3d$xz});
};
...
var $author$project$Main$verticalFieldOfView = $ianmackenzie$elm_units$Angle$degrees(50);
var $author$project$Main$makeCameraGeometry = function (model) {
	var focus = model.focus;
	var azimuth = model.azimuth;
	var elevation = model.elevation;
	var screenDimensions = model.screenDimensions;
	return {
		camera: $ianmackenzie$elm_3d_camera$Camera3d$perspective(
			{
				verticalFieldOfView: $author$project$Main$verticalFieldOfView,
				viewpoint: $author$project$Main$makeViewpoint(model)
			}),
		screenRect: $author$project$Main$makeScreenRectangle(screenDimensions)
	};
};
...
var $author$project$Main$resolution = function (ratio) {
	return A2(
		$ianmackenzie$elm_units$Quantity$per,
		$ianmackenzie$elm_units$Length$inches(1),
		$ianmackenzie$elm_units$Pixels$pixels(48 * ratio));
};
...
var $ianmackenzie$elm_geometry$SketchPlane3d$toPlane = function (sketchPlane) {
	return A2(
...
var $author$project$Main$raycastTo = F4(
	function (sourcePlane, _v0, pixelRatio, _v1) {
		var camera = _v0.camera;
		var screenRect = _v0.screenRect;
		var x = _v1.a;
		var y = _v1.b;
		return A2(
			$elm$core$Maybe$map,
			$ianmackenzie$elm_geometry$Point3d$projectInto(sourcePlane),
			A2(
				$ianmackenzie$elm_geometry$Axis3d$intersectionWithPlane,
				$ianmackenzie$elm_geometry$SketchPlane3d$toPlane(sourcePlane),
				A3(
					...
					A2(
						...
						$author$project$Main$resolution(pixelRatio),
...
var $ianmackenzie$elm_geometry$Vector2d$centimeters = F2(
	function (x, y) {
		return A2(
...
var $author$project$Main$rectFrom = F2(
	function (originPoint, endPoint) {
		var length = A3(
		...
		var bottomRight = A2(
			$ianmackenzie$elm_geometry$Point2d$translateBy,
			A2($ianmackenzie$elm_geometry$Vector2d$plus, length, halfHeight),
			originPoint);
		return A2($ianmackenzie$elm_geometry$Rectangle2d$from, topLeft, bottomRight);
	});
...
var $author$project$Main$reverse = function (key) {
	if (key.$ === 'Left') {
...
var $STTR13$ziplist$ZipList$insertBefore = F2(
	function (newElem, _v0) {
		var before = _v0.a;
		var elem = _v0.b;
		var after = _v0.c;
		return A3(
			$STTR13$ziplist$ZipList$Zipper,
			A2($elm$core$List$cons, newElem, before),
			elem,
			after);
	});
var $author$project$Main$ziplistInsertBefore = F2(
	function (x, ziplist) {
		return $STTR13$ziplist$ZipList$backward(
			A2($STTR13$ziplist$ZipList$insertBefore, x, ziplist));
	});
				...
				switch (msg.$) {
							...
							model,
							{
								drawnRect: A2(
									...
									function (point) {
										return {
											originPoint: point,
											rect: A2($author$project$Main$rectFrom, point, point)
										};
									},
									A4(
										$author$project$Main$raycastTo,
										currentLayer.plane,
										$author$project$Main$makeCameraGeometry(model),
									...
									drawnRect: A2(
										...
										function (endPoint) {
											return _Utils_update(
												rect,
												{
													rect: A2($author$project$Main$rectFrom, rect.originPoint, endPoint)
												});
										},
										A4(
											$author$project$Main$raycastTo,
											...
											rects: A2(
												...
												A2(
													...
													A2(
														...
														A2(
															$elm$core$Basics$composeR,
															$ianmackenzie$elm_geometry$Rectangle3d$on(currentLayer.plane),
															A2($elm_community$basics_extra$Basics$Extra$flip, $elm$core$List$cons, currentLayer.rects))),
													model.drawnRect))
										}),
									model.layers)
							});
					case 'Wheel':
						...
						var add = function (delta) {
							return A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$elm$core$Basics$add(delta * $author$project$Main$wheelCoefficient),
									$ianmackenzie$elm_units$Angle$degrees));
						};
						return _Utils_update(
							model,
							{
								azimuth: A2(add, deltaX, model.azimuth),
								elevation: A2(add, deltaY, model.elevation)
							});
					case 'ClickedTo':
					...
					case 'WindowResize':
						...
						return _Utils_update(
							model,
							{
								screenDimensions: _Utils_Tuple2(width, height)
							});
					case 'ArrowKeyPressed':
						...
						var _v3 = function () {
							if (direction.$ === 'Left') {
								return {
									insert: $STTR13$ziplist$ZipList$insert,
									multiplier: 1,
									shift: $STTR13$ziplist$ZipList$maybeJumpForward(1)
								};
							} else {
								return {
									insert: $author$project$Main$ziplistInsertBefore,
									multiplier: -1,
									shift: $STTR13$ziplist$ZipList$maybeJumpBackward(1)
								};
							}
						}();
						...
						return A2(
							...
							_Utils_update(
								model,
								{
									...
									layers: A2(
										$elm$core$Maybe$withDefault,
										A2(insert, newLayer, model.layers),
										shift(model.layers))
								}));
					default:
						var currentLayer = $STTR13$ziplist$ZipList$current(model.layers);
							...
							model,
							{
								layers: A2(
									...
									_Utils_update(
										currentLayer,
										{
											rects: A2($elm$core$List$drop, 1, currentLayer.rects)
										}),
									model.layers)
							});
				}
...
var $author$project$Main$nonBreakingTexts = function () {
	var nbsp = $elm$core$String$fromChar(
		$elm$core$Char$fromCode(160));
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$List$map(
			A2($elm$core$String$replace, ' ', nbsp)),
		A2(
			$elm$core$Basics$composeR,
			$elm$core$String$join(' '),
...
var $author$project$Main$coordinateDecoder = F2(
	function (prefix, mapper) {
		return A3(
			$elm$json$Json$Decode$map2,
			mapper,
			A2($elm$json$Json$Decode$field, prefix + 'X', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, prefix + 'Y', $elm$json$Json$Decode$float));
	});
...
var $ianmackenzie$elm_geometry$Direction3d$angleFrom = F2(
	function (_v0, _v1) {
		var d1 = _v0.a;
		var d2 = _v1.a;
		var relativeX = ((d1.x * d2.x) + (d1.y * d2.y)) + (d1.z * d2.z);
		var cz = (d1.x * d2.y) - (d1.y * d2.x);
		var cy = (d1.z * d2.x) - (d1.x * d2.z);
		var cx = (d1.y * d2.z) - (d1.z * d2.y);
		var relativeY = $elm$core$Basics$sqrt(((cx * cx) + (cy * cy)) + (cz * cz));
		return $ianmackenzie$elm_units$Quantity$Quantity(
			A2($elm$core$Basics$atan2, relativeY, relativeX));
	});
...
var $ianmackenzie$elm_geometry$Direction3d$equalWithin = F3(
	function (angle, firstDirection, secondDirection) {
		return A2(
			$ianmackenzie$elm_units$Quantity$lessThanOrEqualTo,
			angle,
			A2($ianmackenzie$elm_geometry$Direction3d$angleFrom, firstDirection, secondDirection));
	});
var $author$project$Main$isFacingAwayFrom = function (viewpoint) {
	return A2(
		$elm$core$Basics$composeR,
		$ianmackenzie$elm_geometry$SketchPlane3d$normalDirection,
		A2(
			$ianmackenzie$elm_geometry$Direction3d$equalWithin,
...
var $author$project$Main$screenMargins = 10;
var $author$project$Main$subtractScreenMargins = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return _Utils_Tuple2(x - $author$project$Main$screenMargins, y - $author$project$Main$screenMargins);
};
...
var $ianmackenzie$elm_geometry$Rectangle3d$dimensions = function (_v0) {
	var rectangle = _v0.a;
	return rectangle.dimensions;
};
...
var $ianmackenzie$elm_geometry$Point3d$xyOn = F3(
	function (_v0, _v1, _v2) {
		var sketchPlane = _v0.a;
		var x = _v1.a;
		var y = _v2.a;
		var _v3 = sketchPlane.originPoint;
		var p0 = _v3.a;
		var _v4 = sketchPlane.yDirection;
		var j = _v4.a;
		var _v5 = sketchPlane.xDirection;
		var i = _v5.a;
		return $ianmackenzie$elm_geometry$Geometry$Types$Point3d(
			{x: (p0.x + (x * i.x)) + (y * j.x), y: (p0.y + (x * i.y)) + (y * j.y), z: (p0.z + (x * i.z)) + (y * j.z)});
	});
var $ianmackenzie$elm_geometry$Rectangle3d$edges = function (rectangle) {
	var sketchPlane = $ianmackenzie$elm_geometry$Rectangle3d$axes(rectangle);
	var _v0 = $ianmackenzie$elm_geometry$Rectangle3d$dimensions(rectangle);
	var width = _v0.a;
	var height = _v0.b;
	var y = $ianmackenzie$elm_units$Quantity$half(height);
	var x = $ianmackenzie$elm_units$Quantity$half(width);
	var p1 = A3(
		$ianmackenzie$elm_geometry$Point3d$xyOn,
		sketchPlane,
	...
	var p2 = A3(
		...
		x,
		$ianmackenzie$elm_units$Quantity$negate(y));
	var p3 = A3($ianmackenzie$elm_geometry$Point3d$xyOn, sketchPlane, x, y);
	var p4 = A3(
		$ianmackenzie$elm_geometry$Point3d$xyOn,
		sketchPlane,
		$ianmackenzie$elm_units$Quantity$negate(x),
	...
	return _List_fromArray(
		[
			...
			A2($ianmackenzie$elm_geometry$LineSegment3d$from, p4, p1)
		]);
};
...
var $author$project$Main$projectPoint = function (_v0) {
	var camera = _v0.camera;
	var screenRect = _v0.screenRect;
	return A2($ianmackenzie$elm_3d_camera$Point3d$Projection$toScreenSpace, camera, screenRect);
};
...
var $ianmackenzie$elm_units$Length$inCssPixels = function (length) {
	return $ianmackenzie$elm_units$Length$inMeters(length) / $ianmackenzie$elm_units$Constants$cssPixel;
};
...
var $author$project$Main$svgCoord = A2(
	$elm$core$Basics$composeR,
	$ianmackenzie$elm_geometry$Point2d$toRecord($ianmackenzie$elm_units$Length$inCssPixels),
	function (_v0) {
		var x = _v0.x;
		var y = _v0.y;
		return _Utils_Tuple2(x, y);
...
var $folkertdev$svg_path_lowlevel$Path$LowLevel$toString = $folkertdev$svg_path_lowlevel$Path$LowLevel$toStringWith(_List_Nil);
...
var $ianmackenzie$elm_geometry$SketchPlane3d$normalAxis = function (sketchPlane) {
	return A2(
		$ianmackenzie$elm_geometry$Axis3d$through,
		$ianmackenzie$elm_geometry$SketchPlane3d$originPoint(sketchPlane),
		$ianmackenzie$elm_geometry$SketchPlane3d$normalDirection(sketchPlane));
...
var $author$project$Main$inFrontOf = A2(
	$elm$core$Basics$composeR,
	$ianmackenzie$elm_geometry$SketchPlane3d$normalAxis,
	A2(
		$elm$core$Basics$composeR,
		$ianmackenzie$elm_geometry$Point3d$signedDistanceAlong,
		$elm$core$Basics$composeL(
...
var $author$project$Main$verticesClippedTo = F2(
	function (viewPlane, edge) {
		var _v0 = $ianmackenzie$elm_geometry$LineSegment3d$endpoints(edge);
		var start = _v0.a;
		var end = _v0.b;
		var _v1 = A2(
			$ianmackenzie$elm_geometry$LineSegment3d$intersectionWithPlane,
			$ianmackenzie$elm_geometry$SketchPlane3d$toPlane(viewPlane),
			edge);
		if (_v1.$ === 'Nothing') {
			return A2($author$project$Main$inFrontOf, viewPlane, start) ? _List_fromArray(
				[start, end]) : _List_Nil;
		} else {
			var intersection = _v1.a;
			return A2($author$project$Main$inFrontOf, viewPlane, start) ? _List_fromArray(
				[start, intersection]) : _List_fromArray(
				[intersection, end]);
		}
	});
...
var $author$project$Main$viewFocusRect = F3(
	function (cameraGeometry, hue, rect) {
		var viewPlane = A2(
			$ianmackenzie$elm_geometry$SketchPlane3d$offsetBy,
			A2($ianmackenzie$elm_units$Quantity$multiplyBy, -1, $ianmackenzie$elm_units$Length$centimeter),
			$ianmackenzie$elm_3d_camera$Viewpoint3d$viewPlane(
				$ianmackenzie$elm_3d_camera$Camera3d$viewpoint(cameraGeometry.camera)));
		var coords = A2(
			$elm$core$List$map,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Main$projectPoint(cameraGeometry),
				$author$project$Main$svgCoord),
			A2(
				$elm$core$List$concatMap,
				$author$project$Main$verticesClippedTo(viewPlane),
				$ianmackenzie$elm_geometry$Rectangle3d$edges(rect)));
		var _v0 = A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple2(
				_Utils_Tuple2(0, 0),
				_List_Nil),
			$elm_community$list_extra$List$Extra$uncons(coords));
		var startCoords = _v0.a;
		var remainingCoords = _v0.b;
		var path = {
			drawtos: _List_fromArray(
				[
					A2(
					$folkertdev$svg_path_lowlevel$Path$LowLevel$LineTo,
					$folkertdev$svg_path_lowlevel$Path$LowLevel$Absolute,
					_Utils_ap(
						remainingCoords,
						_List_fromArray(
							[startCoords])))
				]),
			moveto: A2($folkertdev$svg_path_lowlevel$Path$LowLevel$MoveTo, $folkertdev$svg_path_lowlevel$Path$LowLevel$Absolute, startCoords)
		};
		return A2(
			...
			_List_fromArray(
				[
					...
					$folkertdev$svg_path_lowlevel$Path$LowLevel$toString(
						_List_fromArray(
							[path]))),
					$rtfeldman$elm_css$Svg$Styled$Attributes$stroke(
					'hsl(' + ($elm$core$String$fromFloat(hue) + ', 60%, 50%')),
					$rtfeldman$elm_css$Svg$Styled$Attributes$strokeWidth('2'),
					$rtfeldman$elm_css$Svg$Styled$Attributes$strokeDasharray('8 6'),
					$rtfeldman$elm_css$Svg$Styled$Attributes$fillOpacity('0')
				]),
			_List_Nil);
	});
var $author$project$Main$Focusable = F2(
	function (a, b) {
		return {$: 'Focusable', a: a, b: b};
	});
...
var $author$project$Main$ClickedTo = F2(
	function (a, b) {
		return {$: 'ClickedTo', a: a, b: b};
	});
...
var $author$project$Main$projectEdge = function (_v0) {
	var camera = _v0.camera;
	var screenRect = _v0.screenRect;
	return A2($ianmackenzie$elm_3d_camera$LineSegment3d$Projection$toScreenSpace, camera, screenRect);
};
var $author$project$Main$concatMapCarry = function (f) {
	var mapCarrier = F2(
		function (item, _v0) {
			var accumulatedList = _v0.b;
			return A3(
				$elm$core$Tuple$mapBoth,
				$elm$core$Maybe$Just,
				$elm$core$Basics$append(accumulatedList),
				f(item));
		});
	return A2(
		$elm$core$List$foldl,
...
var $ianmackenzie$elm_geometry$Vector2d$zero = $ianmackenzie$elm_geometry$Geometry$Types$Vector2d(
	{x: 0, y: 0});
var $author$project$Main$roundedCornerSegments = F2(
	function (radius, edge) {
		var diameter = A2($ianmackenzie$elm_units$Quantity$multiplyBy, 2, radius);
		var _v0 = $ianmackenzie$elm_geometry$LineSegment2d$endpoints(edge);
		var a = _v0.a;
		var b = _v0.b;
		if (A2(
			$ianmackenzie$elm_units$Quantity$lessThan,
			diameter,
			$ianmackenzie$elm_geometry$LineSegment2d$length(edge))) {
			var endCoord = $author$project$Main$svgCoord(
				$ianmackenzie$elm_geometry$LineSegment2d$midpoint(edge));
			return A2(
				$elm$core$Tuple$pair,
				endCoord,
				_List_fromArray(
					[
						A2(
						$folkertdev$svg_path_lowlevel$Path$LowLevel$QuadraticBezierCurveTo,
						$folkertdev$svg_path_lowlevel$Path$LowLevel$Absolute,
						_List_fromArray(
							[
								_Utils_Tuple2(
								$author$project$Main$svgCoord(a),
								endCoord)
							]))
					]));
		} else {
			var radiusVector = A2(
				...
				A2(
					$elm$core$Maybe$map,
					$ianmackenzie$elm_geometry$Vector2d$withLength(radius),
					$ianmackenzie$elm_geometry$LineSegment2d$direction(edge)));
			var anchorB = A2(
				$ianmackenzie$elm_geometry$Point2d$translateBy,
				$ianmackenzie$elm_geometry$Vector2d$reverse(radiusVector),
				b);
			var endCoord = $author$project$Main$svgCoord(anchorB);
			var anchorA = A2($ianmackenzie$elm_geometry$Point2d$translateBy, radiusVector, a);
			return A2(
				$elm$core$Tuple$pair,
				endCoord,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2(
								$author$project$Main$svgCoord(a),
								$author$project$Main$svgCoord(anchorA))
							])),
						A2(
						$folkertdev$svg_path_lowlevel$Path$LowLevel$LineTo,
						$folkertdev$svg_path_lowlevel$Path$LowLevel$Absolute,
...
var $author$project$Main$roundCorners = F2(
	function (radius, edges) {
		var _v0 = A2(
			$author$project$Main$concatMapCarry,
			$author$project$Main$roundedCornerSegments(radius),
			edges);
		var endCoords = _v0.a;
		var path = _v0.b;
		return A2(
			...
			A2(
				...
				function (coords) {
					return $elm$core$List$singleton(
						{
							drawtos: path,
							moveto: A2($folkertdev$svg_path_lowlevel$Path$LowLevel$MoveTo, $folkertdev$svg_path_lowlevel$Path$LowLevel$Absolute, coords)
						});
				},
				endCoords));
	});
...
var $rtfeldman$elm_css$Svg$Styled$Events$stopPropagationOn = $rtfeldman$elm_css$Html$Styled$Events$stopPropagationOn;
var $ianmackenzie$elm_geometry$Rectangle3d$vertices = function (rectangle) {
	var sketchPlane = $ianmackenzie$elm_geometry$Rectangle3d$axes(rectangle);
	var _v0 = $ianmackenzie$elm_geometry$Rectangle3d$dimensions(rectangle);
	var width = _v0.a;
	var height = _v0.b;
	...
	return _List_fromArray(
		[
			...
			x,
			$ianmackenzie$elm_units$Quantity$negate(y)),
			A3($ianmackenzie$elm_geometry$Point3d$xyOn, sketchPlane, x, y),
			A3(
			$ianmackenzie$elm_geometry$Point3d$xyOn,
			sketchPlane,
			$ianmackenzie$elm_units$Quantity$negate(x),
...
var $author$project$Main$viewRect = F3(
	function (cameraGeometry, behaviour, rect) {
		var viewPlane = $ianmackenzie$elm_3d_camera$Viewpoint3d$viewPlane(
			$ianmackenzie$elm_3d_camera$Camera3d$viewpoint(cameraGeometry.camera));
		if (A2(
			$elm$core$List$all,
			...
			var path = A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$projectEdge(cameraGeometry),
					$ianmackenzie$elm_geometry$Rectangle3d$edges(rect)));
			var attributes = function () {
				if (behaviour.$ === 'Focusable') {
					var layerIndex = behaviour.a;
					var highlightColour = behaviour.b;
					return _List_fromArray(
						[
							$rtfeldman$elm_css$Svg$Styled$Events$onClick(
							A2(
								$author$project$Main$ClickedTo,
								layerIndex,
								$ianmackenzie$elm_geometry$Rectangle3d$centerPoint(rect))),
							A2(
							$rtfeldman$elm_css$Svg$Styled$Events$stopPropagationOn,
							'mousedown',
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$fill(highlightColour)
										]))
								]))
						]);
				} else {
			...
			return $elm$core$Maybe$Just(
				A2(
					...
					A2(
						$elm$core$List$cons,
						$rtfeldman$elm_css$Svg$Styled$Attributes$d(
							$folkertdev$svg_path_lowlevel$Path$LowLevel$toString(path)),
						attributes),
					_List_Nil));
		} else {
			return $elm$core$Maybe$Nothing;
...
var $author$project$Main$viewLayer = F4(
	function (camera, drawnRect, index, _v0) {
		var plane = _v0.plane;
		var rects = _v0.rects;
		var hue = _v0.hue;
		var maybeAppendDrawnRect = A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$ianmackenzie$elm_geometry$Rectangle3d$on(plane),
							A2($author$project$Main$viewRect, camera, $author$project$Main$Inert))),
					drawnRect)));
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$theme.light(hue)),
			...
			maybeAppendDrawnRect(
				A2(
					$elm$core$List$filterMap,
					A2(
						$author$project$Main$viewRect,
						camera,
						A2(
							$author$project$Main$Focusable,
							index,
							$author$project$Main$theme.lighter(hue))),
					rects)));
	});
...
var $author$project$Main$viewSvg = function (model) {
		...
		if (_v1.$ === 'Nothing') {
			return _List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Events$on,
					'mousedown',
					A2($author$project$Main$coordinateDecoder, 'offset', $author$project$Main$MouseDown))
				]);
		} else {
			return _List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Events$on,
					'mousemove',
					A2($author$project$Main$coordinateDecoder, 'offset', $author$project$Main$MouseMove)),
					$rtfeldman$elm_css$Html$Styled$Events$onMouseUp($author$project$Main$MouseUp)
				]);
		}
	}();
	var currentLayer = $STTR13$ziplist$ZipList$current(model.layers);
	var currentIndex = $STTR13$ziplist$ZipList$currentIndex(model.layers);
	var camera = $author$project$Main$makeCameraGeometry(model);
	var orderByDepth = A2(
	...
	var focusRect = A2(
		...
		A2(
			...
			$ianmackenzie$elm_geometry$Frame2d$atPoint(model.centrePoint),
			_Utils_Tuple2(
				$ianmackenzie$elm_units$Length$centimeters((screenWidth * 22) / 1000),
				$ianmackenzie$elm_units$Length$centimeters((screenHeight * 17) / 800))));
	return A2(
		...
		_Utils_ap(
			...
			_List_fromArray(
				[
					...
					'wheel',
					A2(
						$author$project$Main$coordinateDecoder,
						'delta',
						F2(
							function (x, y) {
								return _Utils_Tuple2(
									A2($author$project$Main$Wheel, x, y),
									true);
							})))
				])),
		A2(
			$elm$core$List$cons,
			A3($author$project$Main$viewFocusRect, camera, currentLayer.hue, focusRect),
			orderByDepth(
				A2(
					$elm$core$List$indexedMap,
					function (index) {
						return A3(
							$author$project$Main$viewLayer,
							camera,
							_Utils_eq(index, currentIndex) ? model.drawnRect : $elm$core$Maybe$Nothing,
							index);
					},
					$STTR13$ziplist$ZipList$toList(model.layers)))));
};
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$theme.accent),
								$rtfeldman$elm_css$Css$color($author$project$Main$theme.dark),
				...
				_List_fromArray(
					[
						$author$project$Main$nonBreakingTexts(
						_List_fromArray(
							['Draw rectangles.', 'Scroll to spin.', 'Left/right arrows to switch layers.', 'Click a rectangle to go there.', 'Ctrl+Z to undo.']))
					])),
				A2($rtfeldman$elm_css$Html$Styled$Lazy$lazy, $author$project$Main$viewSvg, model)
			]));
};
	...
	A2(
		...
		function (screenDimensions) {
			return A2(
				...
				function (devicePixelRatio) {
					return $elm$json$Json$Decode$succeed(
						{devicePixelRatio: devicePixelRatio, screenDimensions: screenDimensions});
				},
		...
		A2(
			...
			A2(
				...
				A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$int)))))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Point3d.Point3d":{"args":["units","coordinates"],"type":"Geometry.Types.Point3d units coordinates"},"Main.WorldPoint":{"args":[],"type":"Point3d.Point3d Length.Meters Main.World"}},"unions":{"Main.Msg":{"args":[],"tags":{"MouseDown":["Basics.Float","Basics.Float"],"MouseUp":[],"MouseMove":["Basics.Float","Basics.Float"],"Wheel":["Basics.Float","Basics.Float"],"ClickedTo":["Basics.Int","Main.WorldPoint"],"AnimationTick":["Basics.Float"],"WindowResize":["Basics.Int","Basics.Int"],"ArrowKeyPressed":["Main.ArrowKey"],"CtrlZ":[],"NoOp":[]}},"Main.ArrowKey":{"args":[],"tags":{"Left":[],"Right":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Length.Meters":{"args":[],"tags":{"Meters":[]}},"Geometry.Types.Point3d":{"args":["units","coordinates"],"tags":{"Point3d":["{ x : Basics.Float, y : Basics.Float, z : Basics.Float }"]}},"Main.World":{"args":[],"tags":{"World":[]}}}}})}});
