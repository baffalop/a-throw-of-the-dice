...
import { registerModule, send } from './PortFunnel'

const moduleName = 'WebSocket'

export function init() {
  registerModule(moduleName, { cmd: dispatcher })
...
function doDelay(args) {
  ...
  function callback() {
    send(objectReturn("delayed", { id: args.id }));
  }
